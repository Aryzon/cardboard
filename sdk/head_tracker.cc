...
void HeadTracker::GetPose(int64_t timestamp_ns,
  ...
  if (position_data_->IsValid() && pose_state.timestamp - position_data_->GetLatestTimestamp() < max6DoFTimeDifference) {
      ...
      const Rotation sixDoFRotation = rotation * -difference_to_6DoF_;
      ...
      out_orientation[0] = static_cast<float>(sixDoFRotation.GetQuaternion()[0]);
      out_orientation[1] = static_cast<float>(sixDoFRotation.GetQuaternion()[1]);
      out_orientation[2] = static_cast<float>(sixDoFRotation.GetQuaternion()[2]);
      out_orientation[3] = static_cast<float>(sixDoFRotation.GetQuaternion()[3]);
